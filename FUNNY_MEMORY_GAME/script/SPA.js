...
function switchToStateFromURLHash() {
  ...
  switch (SPAState.pagename) {
    case 'Main':
      pageHTML += '<div class="wrapper_button"><button tabindex="1" id="btn_begin_play" onclick="switchToGamePage()">Start play</button><button tabindex="1" id="btn_records" onclick="switchToRecordsPage()">The best players</button><button  tabindex="1" id="btn_description" onclick="switchToDescriptionPage()">About game</button></div> <div class="main_pencil"><img src="images/pencil.svg" style="width: 60%; height:90%"></div>';
      break;
    case 'Play':
